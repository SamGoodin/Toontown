...
class LaffMeter(DirectFrame):
    ...
    def __init__(self, hp, maxHp, species, headColor):
    ...
    def load(self, species, headColor):
        ...
        if self.isToon:
            ...
            self.maxLabel = DirectLabel(parent=self.eyes, relief=None, pos=(0.442, 0, 0.051), text='120', text_scale=0.4, text_font=Globals.getInterfaceFont())
            self.hpLabel = DirectLabel(parent=self.eyes, relief=None, pos=(-0.398, 0, 0.051), text='120', text_scale=0.4, text_font=Globals.getInterfaceFont())
