...
class OutdoorZone(DirectObject, Hood):
    ...
    def __init__(self, toon, startPosHpr=1):
        ...
        self.pgStorageFile = 'Resources/phase_6/dna/storage_OZ.pdna'
        self.szStorageFile = 'Resources/phase_6/dna/storage_OZ_sz.pdna'
        self.szDNAFile = 'Resources/phase_6/dna/outdoor_zone_sz.pdna'
        if startPosHpr == 1:
